...
------------------------------処理メニュー------------------------------
1:作成 2:表示 3:横棒の削除 4:横棒の追加 5:解を求める 6:終了
処理番号を入力--->1
縦棒の行数，列数と横棒の本数を入力([行数][列数][横棒の本数])--->10 5 20
指定した条件であみだくじを作成できませんでした．
...
1:作成 2:表示 3:横棒の削除 4:横棒の追加 5:解を求める 6:終了
処理番号を入力--->1
縦棒の行数，列数と横棒の本数を入力([行数][列数][横棒の本数])--->10 5 12
   0   1   2   3   4
 0 |   |   |   |   |
 1 |---|   |   |   |
 2 |---|   |   |---|
...
1:作成 2:表示 3:横棒の削除 4:横棒の追加 5:解を求める 6:終了
処理番号を入力--->3
横棒を削除する位置を入力([行][列])--->2 1
指定した位置の横棒を削除できませんでした．

------------------------------処理メニュー------------------------------
1:作成 2:表示 3:横棒の削除 4:横棒の追加 5:解を求める 6:終了
処理番号を入力--->3
横棒を削除する位置を入力([行][列])--->5 2
   0   1   2   3   4
 0 |   |   |   |   |
 1 |---|   |   |   |
 2 |---|   |   |---|
...
1:作成 2:表示 3:横棒の削除 4:横棒の追加 5:解を求める 6:終了
処理番号を入力--->4
横棒を追加する位置を入力([行][列])--->3 2
指定した位置に横棒を追加できませんでした．

------------------------------処理メニュー------------------------------
1:作成 2:表示 3:横棒の削除 4:横棒の追加 5:解を求める 6:終了
処理番号を入力--->4
横棒を追加する位置を入力([行][列])--->7 1
   0   1   2   3   4
 0 |   |   |   |   |
 1 |---|   |   |   |
 2 |---|   |   |---|
